...
class MainActivity : AppCompatActivity() {
    ...
    private fun respostaServidor(response: Response<Main>){
        ...
        if(cidade=="Itaquera"){
            Toast.makeText(applicationContext,"Funcionando!",Toast.LENGTH_SHORT).show()
            binding.imgClima.setBackgroundResource(R.drawable.corinthians)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#000000"))
            binding.containerInfo.setBackgroundResource(R.drawable.container_info_tema_escuro)
            binding.txtTituloInfo.setTextColor(Color.parseColor("#000000"))
            binding.txtInformacoes1.setTextColor(Color.parseColor("#000000"))
        ...
        else if (cidade == "Morumbi"){
            binding.imgClima.setBackgroundResource(R.drawable.sp3)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#8B0000"))
            binding.containerInfo.setBackgroundResource(R.drawable.container_info_tema_claro)
            binding.txtTituloInfo.setTextColor(Color.parseColor("#FFFFFF"))
            binding.txtInformacoes1.setTextColor(Color.parseColor("#FFFFFF"))
            binding.txtInformacoes2.setTextColor(Color.parseColor("#FFFFFF"))
            window.statusBarColor = Color.parseColor("#396BCB")
            binding.txtTemperatura.setTextColor(Color.parseColor("#000000"))
            binding.txtPaisCidade.setTextColor(Color.parseColor("#000000"))


        }
        else if (cidade == "Barra Funda"){
            binding.imgClima.setBackgroundResource(R.drawable.palmeiras_logo)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#006400"))
            binding.containerInfo.setBackgroundResource(R.drawable.container_info_tema_verde)
            binding.txtTemperatura.setTextColor(Color.parseColor("#FFFFFF"))
            binding.txtPaisCidade.setTextColor(Color.parseColor("#FFFFFF"))
            binding.txtTituloInfo.setTextColor(Color.parseColor("#FFFFFF"))
            binding.txtInformacoes1.setTextColor(Color.parseColor("#FFFFFF"))
            ...
            binding.imgClima.setBackgroundResource(R.drawable.santos_logo)
            binding.containerPrincipal.setBackgroundColor(Color.parseColor("#FFFFFF"))
            binding.containerInfo.setBackgroundResource(R.drawable.container_info_tema_claro)
            binding.txtTemperatura.setTextColor(Color.parseColor("#000000"))
            binding.txtPaisCidade.setTextColor(Color.parseColor("#000000"))
            binding.txtTituloInfo.setTextColor(Color.parseColor("#FFFFFF"))
